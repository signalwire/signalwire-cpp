...
int main() {
  ...
  agent.add_skill("datasphere", {{"document_id", "drinks-doc-123"},
                                 {"tool_name", "search_drinks_knowledge"},
                                 {"count", 2},
                                 {"distance", 5.0}});

  // Instance 2: Food knowledge
  agent.add_skill("datasphere", {{"document_id", "food-doc-456"},
  ...
  agent.add_skill("datasphere",
                  {{"document_id", "general-doc-789"}, {"count", 1}, {"distance", 3.0}});
