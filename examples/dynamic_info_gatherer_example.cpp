...
int main() {
  ...
  try {
    ...
    question_sets["default"] =
        json::array({{{"key_name", "name"}, {"question_text", "What is your full name?"}},
                     {{"key_name", "phone"},
    ...
    question_sets["onboarding"] =
        json::array({{{"key_name", "full_name"}, {"question_text", "What is your full name?"}},
                     {{"key_name", "email"},
