...
int main() {
  ...
  try {
    ...
    agent.set_faqs({{{"question", "What are your hours?"},
                     {"answer", "We are open Monday-Friday 9AM-5PM EST."}},
                    {{"question", "What is your return policy?"},
                     {"answer", "You can return items within 30 days for a full refund."}},
                    {{"question", "How do I contact support?"},
                     {"answer", "Email support@example.com or call 1-800-EXAMPLE."}},
                    {{"question", "Do you ship internationally?"},
                     {"answer", "Yes, we ship to over 50 countries."}}});
    agent.set_no_match_message(
        "I don't have an answer for that. Let me connect you with a human agent.");
