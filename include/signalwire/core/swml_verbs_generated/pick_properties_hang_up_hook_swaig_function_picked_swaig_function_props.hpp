...
/// PickPropertiesHangUpHookSWAIGFunctionPickedSWAIGFunctionProps — generated read-side data type.
/// schema.json $defs schema 'PickPropertiesHangUpHookSWAIGFunctionPickedSWAIGFunctionProps'.
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct PickPropertiesHangUpHookSWAIGFunctionPickedSWAIGFunctionProps {
