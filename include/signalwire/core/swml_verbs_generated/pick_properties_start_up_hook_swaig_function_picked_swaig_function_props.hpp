...
/// PickPropertiesStartUpHookSWAIGFunctionPickedSWAIGFunctionProps — generated read-side data type.
/// schema.json $defs schema 'PickPropertiesStartUpHookSWAIGFunctionPickedSWAIGFunctionProps'.
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct PickPropertiesStartUpHookSWAIGFunctionPickedSWAIGFunctionProps {
