...
class Call {
 public:
  ...
  Action play_tts(const std::string& text, const std::string& language = "",
  ...
  Action play_tts(const std::string& text, const std::string& language, Gender gender,
                  const std::string& voice = "", double volume = 0.0);
  ...
  Action prompt_tts(const std::string& text, const json& collect, const std::string& language = "",
                    const std::string& gender = "", const std::string& voice = "",
                    double volume = 0.0);
  ...
  Action detect_answering_machine(const json& amd_params = json::object(), double timeout = -1.0);
