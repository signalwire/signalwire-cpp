...
class RelayApplications : public FabricResource {
 public:
  explicit RelayApplications(const HttpClient& client)
      : FabricResource(client, "/api/fabric/resources/relay_applications", "PUT") {}
};
