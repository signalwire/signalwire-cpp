...
//
// Generated REST wire type for the 'calling' namespace (components/schemas 'AIPostPromptText').
#pragma once
...
/// AIPostPromptText — generated read-side data type.
/// Generated REST wire type for the 'calling' namespace (components/schemas 'AIPostPromptText').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct AIPostPromptText {
