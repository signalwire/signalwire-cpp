...
//
// Generated REST wire type for the 'calling' namespace (components/schemas 'CallUpdateParamsURL').
#pragma once
...
/// CallUpdateParamsURL — generated read-side data type.
/// Generated REST wire type for the 'calling' namespace (components/schemas 'CallUpdateParamsURL').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct CallUpdateParamsURL {
