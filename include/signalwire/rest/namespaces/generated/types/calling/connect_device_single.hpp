...
//
// Generated REST wire type for the 'calling' namespace (components/schemas 'ConnectDeviceSingle').
#pragma once
...
/// ConnectDeviceSingle — generated read-side data type.
/// Generated REST wire type for the 'calling' namespace (components/schemas 'ConnectDeviceSingle').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct ConnectDeviceSingle {
