...
//
// Generated REST wire type for the 'calling' namespace (components/schemas 'UserSWAIGFunction').
#pragma once
...
/// UserSWAIGFunction — generated read-side data type.
/// Generated REST wire type for the 'calling' namespace (components/schemas 'UserSWAIGFunction').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct UserSWAIGFunction {
