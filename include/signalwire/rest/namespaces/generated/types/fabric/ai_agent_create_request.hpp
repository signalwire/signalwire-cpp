...
//
// Generated REST wire type for the 'fabric' namespace (components/schemas 'AIAgentCreateRequest').
#pragma once
...
/// AIAgentCreateRequest — generated read-side data type.
/// Generated REST wire type for the 'fabric' namespace (components/schemas 'AIAgentCreateRequest').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct AIAgentCreateRequest {
