...
//
// Generated REST wire type for the 'fabric' namespace (components/schemas 'AIPromptPomUpdate').
#pragma once
...
/// AIPromptPomUpdate — generated read-side data type.
/// Generated REST wire type for the 'fabric' namespace (components/schemas 'AIPromptPomUpdate').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct AIPromptPomUpdate {
