...
//
// Generated REST wire type for the 'fabric' namespace (components/schemas 'AIPromptTextUpdate').
#pragma once
...
/// AIPromptTextUpdate — generated read-side data type.
/// Generated REST wire type for the 'fabric' namespace (components/schemas 'AIPromptTextUpdate').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct AIPromptTextUpdate {
