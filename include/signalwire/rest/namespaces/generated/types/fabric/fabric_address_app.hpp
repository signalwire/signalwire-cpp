...
//
// Generated REST wire type for the 'fabric' namespace (components/schemas 'FabricAddressApp').
#pragma once
...
/// FabricAddressApp — generated read-side data type.
/// Generated REST wire type for the 'fabric' namespace (components/schemas 'FabricAddressApp').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct FabricAddressApp {
