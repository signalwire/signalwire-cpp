...
//
// Generated REST wire type for the 'fabric' namespace (components/schemas 'FabricAddressCall').
#pragma once
...
/// FabricAddressCall — generated read-side data type.
/// Generated REST wire type for the 'fabric' namespace (components/schemas 'FabricAddressCall').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct FabricAddressCall {
