...
//
// Generated REST wire type for the 'fabric' namespace (components/schemas 'FabricAddressRoom').
#pragma once
...
/// FabricAddressRoom — generated read-side data type.
/// Generated REST wire type for the 'fabric' namespace (components/schemas 'FabricAddressRoom').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct FabricAddressRoom {
