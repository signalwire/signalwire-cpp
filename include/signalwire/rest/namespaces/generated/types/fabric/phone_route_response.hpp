...
//
// Generated REST wire type for the 'fabric' namespace (components/schemas 'PhoneRouteResponse').
#pragma once
...
/// PhoneRouteResponse — generated read-side data type.
/// Generated REST wire type for the 'fabric' namespace (components/schemas 'PhoneRouteResponse').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct PhoneRouteResponse {
