...
//
// Generated REST wire type for the 'fabric' namespace (components/schemas 'SipGatewayRequest').
#pragma once
...
/// SipGatewayRequest — generated read-side data type.
/// Generated REST wire type for the 'fabric' namespace (components/schemas 'SipGatewayRequest').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct SipGatewayRequest {
