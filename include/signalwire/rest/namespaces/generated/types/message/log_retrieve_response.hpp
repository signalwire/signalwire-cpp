...
//
// Generated REST wire type for the 'message' namespace (components/schemas 'LogRetrieveResponse').
#pragma once
...
/// LogRetrieveResponse — generated read-side data type.
/// Generated REST wire type for the 'message' namespace (components/schemas 'LogRetrieveResponse').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct LogRetrieveResponse {
