...
//
// Generated REST wire type for the 'relay_rest' namespace (components/schemas 'SipRecording').
#pragma once
...
/// SipRecording — generated read-side data type.
/// Generated REST wire type for the 'relay_rest' namespace (components/schemas 'SipRecording').
///
...
struct SipRecording {
  ...
  std::optional<json> relay_sip_leg_id;
