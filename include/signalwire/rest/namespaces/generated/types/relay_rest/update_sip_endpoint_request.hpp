...
/// UpdateSipEndpointRequest — generated read-side data type.
/// Generated REST wire type for the 'relay_rest' namespace (components/schemas
/// 'UpdateSipEndpointRequest').
///
/// Method-less DTO: one typed member per snake wire key + open `extras`.
struct UpdateSipEndpointRequest {
  ...
  std::optional<std::string> call_video_room_id;
  std::optional<std::string> call_flow_id;
