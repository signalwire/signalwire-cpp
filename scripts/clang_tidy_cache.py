# VENDORED from matus-chochlik/ctcache — clang-tidy result cache (local-filesystem mode).
# Source: https://github.com/matus-chochlik/ctcache/blob/0c7fee26e09ae8a393ed7d56164102da118ab23a/src/ctcache/clang_tidy_cache.py
# Pinned commit: 0c7fee26e09ae8a393ed7d56164102da118ab23a (2026-04-29)
# License: Boost Software License 1.0 (see upstream LICENSE).
# Audited 2026-07: hash = preprocessed-TU (headers included) + raw #include lines +
#   clang-tidy --dump-config; fail-open (any hash/cache error -> runs real clang-tidy;
#   a finding is never silently skipped); local mode = filesystem only, no network.
# To upgrade: re-vendor from a newer pinned SHA and re-audit the hashing + fail-open paths.
#
#!/usr/bin/env python3
# coding: UTF-8
