...
def emit_method(spec: Spec, anchor: str, markup: dict, base: str,
    ...
    if name != snake_to_camel(method_snake):
...
def emit_resource_tree(placed) -> str:
    ...
    lines.append("")
    lines.append("/// ResourceTree — generated flat resources + namespace containers (§8).")
    lines.append("/// Placement resolved from x-sdk-namespace.attr + per-resource")
    lines.append("/// x-sdk-resource.namespace/attr; base paths per §4.")
