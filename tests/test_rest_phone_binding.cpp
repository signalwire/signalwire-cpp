...
TEST(phone_call_handler_covers_11_members) {
  ...
  int seen = 0;
  for (auto h : {
           PhoneCallHandler::RelayScript,
           PhoneCallHandler::LamlWebhooks,
           PhoneCallHandler::LamlApplication,
           PhoneCallHandler::AiAgent,
           PhoneCallHandler::CallFlow,
           PhoneCallHandler::RelayApplication,
           PhoneCallHandler::RelayTopic,
           PhoneCallHandler::RelayContext,
           PhoneCallHandler::RelayConnector,
           PhoneCallHandler::VideoRoom,
...
TEST(phone_binding_swml_webhook_body) {
  ...
  ASSERT_EQ(body["call_relay_script_url"].get<std::string>(),
            std::string("https://example.com/swml"));
...
TEST(phone_binding_cxml_webhook_body_minimal) {
  ...
  ASSERT_EQ(body["call_request_url"].get<std::string>(),
            std::string("https://example.com/voice.xml"));
...
TEST(phone_binding_cxml_webhook_body_with_options) {
  ...
  ASSERT_EQ(body["call_request_url"].get<std::string>(),
            std::string("https://example.com/voice.xml"));
  ASSERT_EQ(body["call_fallback_url"].get<std::string>(),
            std::string("https://example.com/fallback.xml"));
  ASSERT_EQ(body["call_status_callback_url"].get<std::string>(),
